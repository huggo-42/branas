...
test("Deve testar o progresso no preenchimento", async () => {
    ...
    await wrapper.get(".input-cpf").setValue("1234567890");
...
test("Deve testar a visibilidade dos componentes", async () => {
    ...
    expect(wrapper.find(".input-is-name").exists()).toBe(false);
    expect(wrapper.find(".input-is-email").exists()).toBe(false);
    expect(wrapper.find(".input-is-cpf").exists()).toBe(false);
    expect(wrapper.find(".input-is-password").exists()).toBe(false);
    expect(wrapper.find(".input-is-confirm-password").exists()).toBe(false);
...
test("Deve testar os erros no preenchimento", async () => {
    ...
    await wrapper.get(".input-password").setValue("123123");
    await wrapper.get(".button-confirm").trigger("click");
    expect(wrapper.get(".error").text()).toBe("Digite a confirmação da senha");
    await wrapper.get(".input-confirm-password").setValue("987987");
    await wrapper.get(".button-confirm").trigger("click");
    expect(wrapper.get(".error").text()).toBe("A senha e a confirmação da senha devem ser iguais");
    await wrapper.get(".input-confirm-password").setValue("123123");
    await wrapper.get(".button-confirm").trigger("click");
    expect(wrapper.find(".error").exists()).toBe(false);
});
